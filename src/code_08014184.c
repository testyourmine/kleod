...
void sub_08014760(u8 arg0)
{
    ...
    switch (gEntityInfo[arg0].unkF)
    {
        ...
        case 1:
            ...
            if ((gUnk_03004654->unk18 <= var_r7) && (gEntityInfo[arg0].unkF == 0))
            {
...
block_240:
            ...
            if (((u32) gUnk_03004654->unk18 <= (u32) var_r7) || (((u32) gUnk_03004654->unk1 <= (u32) var_r7) && ((u32) gUnk_03004654->unk14 >= (u32) var_r7) && (gUnk_03004C20.levelHasWarpDoors == 0)))
            {
...
block_379:
                                ...
                                else if (gUnk_03005220.oneWayGateOpen != 0)
                                {
            ...
            if ((gEntityInfo[arg0].id == ENTITY_ID_MOO) || (gEntityInfo[arg0].id == ENTITY_ID_BOOMIE))
            {
                if ((gUnk_03004C20.globalFrameCounter % 2) != 0)
                {
                    ...
                    if (gEntityInfo[arg0].unk8.split.unk9 == 2)
                    {
                        if (gEntityInfo[arg0].unkC_2 == 0)
                        {
                            if (gBgDataPtrs.pBufBg2Tilemap[((gEntityInfo[arg0].xPosBg2 + 4) >> 3) + (((gEntityInfo[arg0].yPosBg2 + 4) >> 3) * gBgInfo[2].hLength)] < gUnk_03004654->unk0)
                            {
            ...
            else
            {
                if ((gEntityInfo[arg0].xPosBg2 - 0xDC) < gEntityInfo[0].xPosBg2)
                {
                    if (gUnk_03004C20.level != 8)
                    {
                        ...
                        sp0 = sub_08014184(gEntityInfo[arg0].xPosBg2 + 8, gEntityInfo[arg0].yPosBg2, 0x18);
                        if (sp0.unk0 != 0xFFFF)
                        {
                        ...
                        sp4 = sub_08014230(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x18);
                        if (sp4.unk0 != 0xFFFF)
                        {
...
block_128:
                    ...
                    sp0 = sub_08014184(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x18);
                    if (sp0.unk0 != 0xFFFF)
                    {
                        sp34 = gUnk_03004654->unk1B;
                    }
                    ...
                    spC = sub_08014230(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x18);
                    if (spC.unk0 != 0xFFFF)
                    {
        ...
        case 17:
            ...
            case 22:
                if ((gEntityInfo[arg0].unkF == 0x15) || (gEntityInfo[arg0].unkF == 0x10))
                {
                    ...
                    {
                        sp4 = sub_08014184(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x18);
                        if (sp4.unk0 != 0xFFFF)
                        {
                            sp34 = gUnk_03004654->unk1B;
                        }
                        ...
                        {
                            sp14 = sub_08014230(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x18);
    ...
    block_472:
                ...
                else
                {
                    ...
                    if (gUnk_03004C20.unkA == 1)
                    {
                        sp14 = sub_08014184(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x18);
                        if (sp14.unk0 == 0xFFFF)
                        {
                            sp1C = sub_08014230(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x18);
    ...
    block_478:
                ...
                for (sp28 = gUnk_030008F4; sp28 <= gUnk_030008F0; sp28++)
                {
                    ...
                    switch (gEntityInfo[sp28].id)
                    {
                        ...
                        case ENTITY_ID_ONE_WAY_GATE:
                            ...
                            {
                                if ((((u8) gEntityInfo[sp28].unkC_4) == 1) && (((u8) gUnk_03005220.oneWayGateOpen) == 0))
                                {
                ...
                if (gUnk_03004654->unk1A > sp34)
                {
                    if (gUnk_03004654->unk1 > sp34)
                    {
                        goto block_716;
                    }
                    if (gUnk_03004654->unk14 < sp34)
                    {
                        goto block_716;
                    }
...
block_716:
        ...
        case 23:
            if (gEntityInfo[arg0].unkF == 0xE)
            {
                ...
                if ((gUnk_03004C20.unkA == 1) && (sp = sub_08014230(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x18), sp.unk0 != 0xFFFF))
                {
                    sp34 = gUnk_03004654->unk1B;
                }
                else
...
void sub_0801B044(u8 arg0)
{
    ...
    if (gEntityInfo[arg0].unk8.all++ < 0xF0)
    {
        ...
        if ((u32) (u16) (gEntityInfo[arg0].unk8.all - 0xBF) <= 8)
        {
            ...
            {
                gEntityInfo[arg0].xPosBg2 += gUnk_03005220.klonoaCannonXVel;
            }
    ...
    else if ((u32) (u16) (gEntityInfo[arg0].unk8.all - 0x12D) <= 0x80)
    {
        ...
        if ((u32) (u16) (gEntityInfo[arg0].unk8.all - 0x12D) <= 0x12)
        {
            ...
            {
                gEntityInfo[arg0].xPosBg2 += gUnk_03005220.klonoaCannonXVel;
                gEntityInfo[arg0].yPosBg2 -= gUnk_03005220.klonoaCannonXVel;
...
void sub_0801DFC4(u8 arg0)
{
    ...
    if (gUnk_03004654->unk1A <= gBgDataPtrs.pBufBg2Tilemap[(gEntityInfo[arg0].xPosBg2 >> 3) + ((gEntityInfo[arg0].yPosBg2 >> 3) * gBgInfo[2].hLength)])
    {
        block_4:
        sub_0801E664(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 2, 0);
        gEntityInfo[arg0].unkF = 0x1C;
...
void sub_0801E354(u8 arg0)
{
    if (gEntityInfo[arg0].yPosScreen >= 0x90)
    {
        ...
        {
            gUnk_03005220.collected1Ups |= 1 << gEntityInfo[arg0].unk8.split.unk8;
...
void sub_0801EAA4(u8 arg0)
{
    ...
    if (gEntityInfo[arg0].id == ENTITY_ID_WATER_SWITCH)
    {
        ...
        if (gEntityInfo[arg0 + 1].unkC_4 == 0)
        {
            gUnk_03005220.pressedWaterSwitches ^= (1 << gUnk_080E2B64[gUnk_03004C20.world - 1][gUnk_03004C20.level - 1][arg0 - 0xD].unk0[gUnk_03004C20.room - 1].unk4);
        }
        else
        {
            gUnk_03005220.pressedWaterSwitches |= (1 << gUnk_080E2B64[gUnk_03004C20.world - 1][gUnk_03004C20.level - 1][arg0 - 0xD].unk0[gUnk_03004C20.room - 1].unk4);
    ...
    else if (gEntityInfo[arg0].id == ENTITY_ID_GROWING_SHRINKING_BLOCK_SWITCH)
    {
        ...
        gEntityInfo[arg0].unkC_4 = gUnk_03005220.pressedGrowingShrinkingBlockSwitch ^= 1;
...
void sub_0801F128(u8 arg0)
{
    ...
    switch (gEntityInfo[arg0].unkF)
    {
        ...
        case ENTITY_ID_FLAME_WAVE:
            ...
            {
                if (((gEntityInfo[arg0].yPosBg2 + gUnk_080E2AB4[5 - gEntityAnimationInfo[arg0 - gUnk_0300363C].frame][4]) < gEntityInfo[0].yPosBg2) && ((gEntityInfo[arg0].yPosBg2 + gUnk_080E2AB4[5 - gEntityAnimationInfo[arg0 - gUnk_0300363C].frame][5]) > (gEntityInfo[0].yPosBg2 - 0x18)) && (gUnk_03005220.klonoaInvulnerabilityTimer == 0) && (gUnk_03005400.unkC != 0))
                {
                    ReceiveDamage(1);
                }
            }
        ...
        case 0:
            ...
            {
                if (((gEntityInfo[arg0].yPosBg2 + gUnk_080E2AB4[gEntityAnimationInfo[arg0 - gUnk_0300363C].frame + 1][4]) < gEntityInfo[0].yPosBg2) && ((gEntityInfo[arg0].yPosBg2 + gUnk_080E2AB4[gEntityAnimationInfo[arg0 - gUnk_0300363C].frame + 1][5]) > (gEntityInfo[0].yPosBg2 - 0x18)) && (gUnk_03005220.klonoaInvulnerabilityTimer == 0) && (gUnk_03005400.unkC != 0))
                {
                    ReceiveDamage(1);
                }
            }
...
void sub_08020FB8(u8 arg0)
{
    ...
    switch (gEntityInfo[arg0].unkF)
    {
        case 25:
            ...
            SetEntityAnimationInfoState(arg0, 0x11);
            gEntityInfo[arg0].unkF = 0;
    ...
    switch (gEntityInfo[arg0].unkF)
    {
        ...
        case 1:
            ...
            else
            {
                if (gEntityAnimationInfo[arg0 - gUnk_0300363C].timer == 0xFF)
                {
                    ...
                    m4aSongNumStop(0x83);
                    DmaCopy16Wait(3, gUnk_0818B7DC[gEntityInfo[arg0].unk8.split.unk9], OBJ_PLTT + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[arg0 - 0xC].bpp_paletteNum * 0x20), 0x20);
                    SetEntityAnimationInfoState(arg0, gEntityInfo[arg0].unk8.split.unk9 & 0xF);
                    gUnk_03003590[4].unk2 = 0;
                    gUnk_03003590[4].unk0 = 0;
                }
                else
        ...
        case 16:
            ...
            if (gEntityAnimationInfo[arg0 - gUnk_0300363C].state != 0x1A)
            {
                ...
                SetEntityAnimationInfoState(arg0, 0x1A);
                gUnk_03003590[4].unk4 = 0;
                DmaCopy16Wait(3, gUnk_0818B7DC[0], OBJ_PLTT + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[arg0 - 0xC].bpp_paletteNum * 0x20), 0x20);
            }
            else
...
void sub_08022CA0(u8 arg0)
{
    ...
    switch (gEntityInfo[arg0].unkF)
    {
        case 25:
            ...
            SetEntityAnimationInfoState(arg0, 0xD);
        ...
        case 0:
            ...
            {
                SetEntityAnimationInfoState(arg0, temp_r6 + 7);
                break;
            }
        ...
        case 16:
            ...
            else
            {
                ...
                gEntityInfo[arg0].yPosBg2 += 1;
                temp_r2 = sub_08014230(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2 - 4, 0x10);
        ...
        case 17:
            ...
            temp_r2 = sub_08014184(gEntityInfo[arg0].xPosBg2 + temp_r5, gEntityInfo[arg0].yPosBg2, 0x18);
            if (temp_r2.unk0 != 0xFFFF)
            {
        ...
        case 15:
            ...
            {
                SetEntityAnimationInfoState(arg0, temp_r6 + 0xA);
            }
        ...
        case 7:
            ...
            else
            {
                if (gEntityAnimationInfo[arg0 - gUnk_0300363C].timer == 0xFF)
                {
                    ...
                    {
                        gEntityInfo[arg0].unk8.split.unk8 = 0x1E;
                        SetEntityAnimationInfoState(arg0, 0x12);
                    }
                }
            }
            if (gEntityInfo[arg0].unk16 == 0)
        ...
        case 10:
            ...
            if (gUnk_03003590[2].unk0 > 0x80 && gUnk_03003590[2].unk0 < 0xA0)
            {
                ...
                {
                    if (((gEntityInfo[0].yPosBg2 - 0x18) < gEntityInfo[arg0].yPosBg2) && (gEntityInfo[0].yPosBg2 > (gEntityInfo[arg0].yPosBg2 - 0x60)) && (gUnk_03005220.klonoaInvulnerabilityTimer == 0))
                    {
                        ReceiveDamage(1);
                    }
                }
...
void sub_08023988(u8 arg0)
{
    ...
    switch (gEntityInfo[arg0].unkF)
    {
        case 25:
            ...
            gEntityInfo[arg0].unk8.split.unk8 = 0x20;
            SetEntityAnimationInfoState(arg0, 0x13);
        ...
        case 0:
            ...
            if (gEntityInfo[arg0].unk8.split.unk8 != 0)
            {
                ...
                var_r2 = sub_08014230(gEntityInfo[arg0].xPosBg2 + 4, gEntityInfo[arg0].yPosBg2 - 8, 0x10);
            ...
            var_r2 = sub_08014230(gEntityInfo[arg0].xPosBg2 + 4, gEntityInfo[arg0].yPosBg2 - 0x10, 0x10);
            if (var_r2.unk0 != 0xFFFF)
            {
            ...
            if (gEntityInfo[arg0].unkC_2 & 1)
            {
                var_r2 = sub_08014184(gEntityInfo[arg0].xPosBg2 - 8, gEntityInfo[arg0].yPosBg2, 0x18);
            }
            else
            {
                var_r2 = sub_08014184(gEntityInfo[arg0].xPosBg2 + 8, gEntityInfo[arg0].yPosBg2, 0x18);
...
void sub_08023BC0(u8 arg0)
{
    ...
    switch (gEntityInfo[arg0].unkF)
    {
        case 25:
            ...
            SetEntityAnimationInfoState(arg0, 0x15);
            break;
        ...
        case 0:
            ...
            {
                gEntityInfo[arg0].yPosBg2 += 1;
                temp_r2 = sub_08014230(gEntityInfo[arg0].xPosBg2, gEntityInfo[arg0].yPosBg2, 0x10U);
                if (temp_r2.unk0 != 0xFFFF)
                {
                    gEntityInfo[arg0].yPosBg2 = temp_r2.unk0;
                    gEntityInfo[arg0].unk8.split.unk8 = 0x78;
                    SetEntityAnimationInfoState(arg0, 0x16);
                }
            }
            break;
        ...
        case 17:
            ...
            {
                gEntityInfo[arg0].unk8.split.unk8 = 0x78;
                SetEntityAnimationInfoState(arg0, 0x17);
            }
            break;
