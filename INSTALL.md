First, you must put a `Klonoa - Empire of Dreams (USA)` ROM (with SHA1: `a0a298d9dba1ba15d04a42fc2eb35893d1a9569b`) in the root directory of the repository and name it `baserom.gba`. 
...
Install the `binutils-arm-none-eabi` package to use the toolchain. **devkitARM** is currently *not* supported.

## Installation

To set up the repository:

	git clone https://github.com/testyourmine/kleod
