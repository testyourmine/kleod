...
sub_080240F4: @ 0x080240F4
	...
	bne _080241D4
	movs r3, #0
	ldr r0, _08024170 @ =gUnk_03003510
	adds r2, r0, #0
	adds r2, #0x78
	ldrb r1, [r2]
	movs r4, #0
...
sub_080241EC: @ 0x080241EC
	...
	bne _080242A6
	movs r3, #0
	ldr r0, _08024268 @ =gUnk_03003510
	adds r2, r0, #0
	adds r2, #0x78
	ldrb r1, [r2]
	movs r4, #0
...
_08024432:
	...
	strb r0, [r2]
	movs r3, #0
	ldr r0, _080244A0 @ =gUnk_03003510
	adds r2, r0, #0
	adds r2, #0x78
	ldrb r1, [r2]
	movs r4, #0
...
sub_08024560: @ 0x08024560
	...
	rsbs r0, r0, #0
	str r0, [r5]
	ldr r1, _080245D4 @ =gUnk_03003510
...
_080245FE:
	...
	rsbs r7, r7, #0
	str r7, [r5]
	ldr r1, _08024668 @ =gUnk_03003510
...
_080247D0:
	...
	strb r4, [r0]
	bl sub_0800A468
	ldr r2, _08024860 @ =gUnk_030034AC
	ldr r1, _08024864 @ =gUnk_03005420
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r0, _08024868 @ =gUnk_03002910
	strb r4, [r0]
	...
	adds r0, r2, r3
	strb r1, [r0]
	ldr r2, _08024870 @ =gUnk_03003510
	adds r3, r2, #0
	adds r3, #0x78
	ldrb r0, [r3]
	movs r4, #0
...
_08024860: .4byte gUnk_030034AC
_08024864: .4byte gUnk_03005420
_08024868: .4byte gUnk_03002910
_0802486C: .4byte gUnk_03002920
_08024870: .4byte gUnk_03003510
...
_08024886:
	cmp r4, #1
	bne _080248A6
	ldr r1, _0802491C @ =gUnk_03003510
	adds r2, r1, #0
	adds r2, #0x78
	ldrb r0, [r2]
	subs r0, #1
...
sub_080249A4: @ 0x080249A4
	...
	bne _08024A6A
	movs r3, #0
	ldr r0, _08024A24 @ =gUnk_03003510
	adds r2, r0, #0
	adds r2, #0x78
	ldrb r1, [r2]
	movs r4, #0
...
sub_08024A78: @ 0x08024A78
	...
	strb r4, [r2]
	bl sub_080008DC
	ldr r2, _08024B10 @ =gUnk_030034AC
	ldr r1, _08024B14 @ =gUnk_03005420
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r0, _08024B18 @ =gUnk_03002910
	strb r4, [r0]
	...
	ldr r0, [r0]
	strb r4, [r0, #0xc]
	ldr r1, _08024B30 @ =gUnk_03003510
...
_08024B10: .4byte gUnk_030034AC
_08024B14: .4byte gUnk_03005420
_08024B18: .4byte gUnk_03002910
...
sub_08024B54: @ 0x08024B54
	...
	strb r4, [r2]
	bl sub_080008DC
	ldr r2, _08024BF0 @ =gUnk_030034AC
	ldr r1, _08024BF4 @ =gUnk_03005420
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r0, _08024BF8 @ =gUnk_03002910
	strb r4, [r0]
	...
	ldr r0, [r0]
	strb r4, [r0, #0xc]
	ldr r2, _08024C10 @ =gUnk_03003510
...
_08024BF0: .4byte gUnk_030034AC
_08024BF4: .4byte gUnk_03005420
_08024BF8: .4byte gUnk_03002910
...
_08024C68:
	strb r4, [r2]
	bl sub_080008DC
	ldr r2, _08024CEC @ =gUnk_030034AC
	ldr r1, _08024CF0 @ =gUnk_03005420
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r0, _08024CF4 @ =gUnk_03002910
	strb r4, [r0]
	...
	strb r0, [r2, #4]
	strb r7, [r6]
	ldr r1, _08024D14 @ =gUnk_03003510
...
_08024CEC: .4byte gUnk_030034AC
_08024CF0: .4byte gUnk_03005420
_08024CF4: .4byte gUnk_03002910
...
_08024D1C:
	...
	strb r4, [r2, #9]
	strb r4, [r2, #0xa]
	ldr r1, _08024D5C @ =gUnk_03003510
...
_08024F92:
	...
	movs r1, #0xff
	bl m4aMPlayVolumeControl
	ldr r1, _08025010 @ =gUnk_03003510
...
_0802507A:
	strb r3, [r7]
	ldr r2, _08025238 @ =gUnk_030034AC
	ldr r1, _0802523C @ =gUnk_03005420
	movs r7, #0x80
	lsls r7, r7, #1
	adds r0, r7, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r0, _08025240 @ =gUnk_03002910
	strb r3, [r0]
	strb r4, [r5]
...
_080250A4:
	...
	strb r6, [r2, #9]
	strb r1, [r2, #0xa]
	ldr r1, _0802525C @ =gUnk_03003510
...
_08025238: .4byte gUnk_030034AC
_0802523C: .4byte gUnk_03005420
_08025240: .4byte gUnk_03002910
...
_080252BA:
	...
	bl sub_08046DB8
_080252EE:
	ldr r1, _08025330 @ =gUnk_03003510
...
_08025570:
	cmp r2, #2
	bne _0802559C
	ldr r1, _08025594 @ =gUnk_03003510
	...
	b _08025628
	.align 2, 0
_08025594: .4byte gUnk_03003510
_08025598: .4byte sub_0804BE58
_0802559C:
	cmp r2, #7
	bne _080255E4
	ldr r1, _080255D0 @ =gUnk_03003510
...
_080255E4:
	...
	strb r4, [r2, #9]
	strb r4, [r2, #0xa]
	ldr r1, _08025614 @ =gUnk_03003510
...
sub_08025634: @ 0x08025634
	...
	bne _08025704
	strb r5, [r2]
	ldr r2, _080256D4 @ =gUnk_030034AC
	ldr r1, _080256D8 @ =gUnk_03005420
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r0, _080256DC @ =gUnk_03002910
	strb r5, [r0]
	...
	strb r5, [r2, #9]
	strb r5, [r2, #0xa]
	ldr r1, _080256F8 @ =gUnk_03003510
...
_080256D4: .4byte gUnk_030034AC
_080256D8: .4byte gUnk_03005420
_080256DC: .4byte gUnk_03002910
...
sub_08025718: @ 0x08025718
	...
	bne _080257FC
	movs r3, #0
	ldr r0, _08025798 @ =gUnk_03003510
	adds r2, r0, #0
	adds r2, #0x78
	ldrb r1, [r2]
	movs r4, #0
...
sub_08025818: @ 0x08025818
	...
	bne _080258EC
	strb r5, [r2]
	ldr r2, _080258B8 @ =gUnk_030034AC
	ldr r1, _080258BC @ =gUnk_03005420
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r0, _080258C0 @ =gUnk_03002910
	strb r5, [r0]
	...
	str r4, [r6]
	bl sub_0800A468
	ldr r1, _080258D8 @ =gUnk_03003510
...
_080258B8: .4byte gUnk_030034AC
_080258BC: .4byte gUnk_03005420
_080258C0: .4byte gUnk_03002910
...
sub_08025954: @ 0x08025954
	...
	bne _08025A0E
	movs r3, #0
	ldr r0, _080259D0 @ =gUnk_03003510
	adds r2, r0, #0
	adds r2, #0x78
	ldrb r1, [r2]
	movs r4, #0
...
_08025A60:
	...
	mov r3, r8
	str r0, [r3]
	ldr r2, _08025B34 @ =gUnk_030034AC
	ldr r1, _08025B38 @ =gUnk_03005420
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r0, _08025B3C @ =gUnk_03002910
	strb r6, [r0]
	ldrh r1, [r5]
	...
	ldr r0, [r0]
	strb r6, [r0, #0xc]
	ldr r1, _08025B4C @ =gUnk_03003510
...
_08025B34: .4byte gUnk_030034AC
_08025B38: .4byte gUnk_03005420
_08025B3C: .4byte gUnk_03002910
_08025B40: .4byte 0x0000FFFD
_08025B44: .4byte 0x0000FFEF
_08025B48: .4byte gUnk_03004658
_08025B4C: .4byte gUnk_03003510
...
sub_08025DD4: @ 0x08025DD4
	...
	ldr r4, _08025E54 @ =gUnk_03000900
_08025DDC:
	ldrb r0, [r7]
	lsls r0, r0, #0x1e
	lsrs r0, r0, #0x1e
...
_08025EAC:
	movs r5, #1
	ldr r6, _08025ED4 @ =gUnk_03000900
	cmp r2, #0x63
	ble _08025EE4
...
_08025ED4: .4byte gUnk_03000900
_08025ED8: .4byte 0x000004A4
_08025EDC: .4byte 0x000004E4
_08025EE0:
	movs r5, #0
	ldr r6, _08025F80 @ =gUnk_03000900
_08025EE4:
	mov r7, r8
	ldrh r0, [r7]
	lsls r0, r0, #0x14
...
sub_08025F94: @ 0x08025F94
	...
	cmp r1, #9
	bls _08025FF8
	ldr r4, _08025FE4 @ =gUnk_03000900
	adds r0, r1, #0
	movs r1, #0xa
	bl __udivsi3
	lsls r0, r0, #0x18
...
sub_08026090: @ 0x08026090
	...
	adds r5, #0x4c
	ldrb r0, [r5]
	ldr r4, _08026114 @ =gUnk_03000900
	cmp r0, #9
	bls _080260D2
	movs r1, #0xa
	bl __udivsi3
...
sub_08026128: @ 0x08026128
	...
	ldr r6, _080261FC @ =gUnk_03000900
...
sub_08026374: @ 0x08026374
	...
	mov r7, r8
	push {r7}
	ldr r2, _080263A0 @ =gUnk_03003510
	ldr r1, [r2, #0x10]
...
sub_080264A4: @ 0x080264A4
	...
	mov r5, r8
	push {r5, r6, r7}
	ldr r0, _08026550 @ =gUnk_03003510
	ldr r1, [r0, #0x14]
...
_080265C2:
	bl sub_080008DC
	ldr r2, _080265FC @ =gUnk_030034AC
	ldr r1, _08026600 @ =gUnk_03005420
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
	strh r0, [r1]
	strh r0, [r2]
	ldr r1, _08026604 @ =gUnk_03002910
	movs r0, #0
	strb r0, [r1]
...
_080265FC: .4byte gUnk_030034AC
_08026600: .4byte gUnk_03005420
_08026604: .4byte gUnk_03002910
...
_0802661E:
	mov sl, r2
	ldr r2, _0802665C @ =gUnk_03003510
