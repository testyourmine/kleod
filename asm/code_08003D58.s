...
_08004434:
	...
	lsls r0, r0, #3
	adds r0, r0, r2
	ldr r6, _080044B4 @ =gUnk_080D8E14
	adds r1, r6, #0
	adds r1, #0x80
	ldrh r1, [r1]
	strh r1, [r0, #6]
...
_08004796:
	...
	orrs r0, r1
	strb r0, [r3, #0xd]
	ldr r6, _08004894 @ =gUnk_080D8E14
	adds r0, r6, #0
	adds r0, #0x80
	movs r1, #0
	ldrsh r4, [r0, r1]
...
_0800489C:
	...
	orrs r0, r1
	strb r0, [r4, #0xd]
	ldr r6, _08004994 @ =gUnk_080D8E14
	adds r0, r6, #0
	adds r0, #0x80
	movs r2, #0
	ldrsh r1, [r0, r2]
